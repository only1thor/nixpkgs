{ lib, stdenv, fetchFromGitHub, makeWrapper, patchelf, autoPatchelfHook, libusb1, curl, openssl, libevdev, json_c, hidapi, gcc, libgcc, cmake, pkg-config, python3 }:
...
stdenv.mkDerivation (finalAttrs: {
  ...
  buildInputs = [ libusb1 curl openssl libevdev json_c hidapi gcc libgcc gcc.cc.lib ];
